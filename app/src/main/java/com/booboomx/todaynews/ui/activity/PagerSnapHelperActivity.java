 ...
 */
public class PagerSnapHelperActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener{


    public static final String TAG=PagerSnapHelperActivity.class.getSimpleName();
